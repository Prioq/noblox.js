 ...
 * @param {apiUrl=} apiUrl - The URL to send the request to.
...
exports.func = (args) => {
  ...
  return http({
    url: `//${apiUrl}/v2/get-user-conversations?pageNumber=` + pageNumber + '&pageSize=' + pageSize,
    options: {
      method: 'GET',
      jar,
